...
public class SellerFormController implements Initializable {
	...
	@FXML
	private CheckBox checkBoxDepartment;
	...
	private Seller getFormData() {
		...
		return new Seller(Utils.tryParserToInt(txtId.getText()), txtName.getText(), txtEmail.getText(), null , Double.parseDouble(txtBaseSalary.getText()), null);
	}
